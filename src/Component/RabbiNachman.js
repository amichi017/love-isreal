...
כֹּל הַנְּשָׁמָה תְּהַלֵּל יָהּ הַלְלוּיָהּ`}
    ...
    <Accordion>
        ...
        <AccordionSummary
          ...
          id="panel1a-header"
        >
           <Typography align='right' className={this.props.classes.heading}> תפילה לאחר התקון הכללי </Typography>
        </AccordionSummary>
