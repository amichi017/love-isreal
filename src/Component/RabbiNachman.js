    ...
    render() {
        return ( 
            ...
            <Card className={this.props.classes.paper} >  
                    ...
                    <Typography variant="h3" gutterBottom align='center' color="inherit" style={{paddingTop:25}}>
                        {"תפילה קצרה לפני התיקון הכללי"}
                    </Typography>
            

                    <Typography variant="h4" gutterBottom align='center' style={{paddingTop:25}}>
...
כֹּל הַנְּשָׁמָה תְּהַלֵּל יָהּ הַלְלוּיָהּ`}
        ...
        <AccordionSummary
          ...
          dir="rtl"
        >
           <Typography variant="h2" gutterBottom align='center'  dir="rtl" className={this.props.classes.heading}> לקריאת התפילה לאחר התיקון הכללי לחץ כאן </Typography>
        </AccordionSummary>

        <AccordionDetails>
        <Typography variant="h5" gutterBottom align='center' color="inherit" style={{paddingTop:25,marginBottom:35}}>

               <Typography variant="h4" gutterBottom align='center' color="inherit" style={{paddingTop:25,marginBottom:35}}>
