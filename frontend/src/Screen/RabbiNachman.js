...
const styles = theme => ({
    paper: {
      ...
      marginTop:theme.spacing(-window.innerHeight*0.1),
      marginLeft:(window.innerWidth<600)?window.innerWidth*0.02:window.innerWidth*0.1,
...
class RabbiNachman extends Component {
    render() {
        return ( 
            <div>
            ...
            <Card className={this.props.classes.paper} >  
                    ...
                    <Typography variant="h3" gutterBottom align='center' color='primary' style={{paddingTop:25,}}>
                        {"תפילה קצרה לפני התיקון הכללי"}
                    </Typography>
            

                    <Typography variant="h4" gutterBottom align='center'  color='textSecondary' style={{paddingTop:25}}>
...
וְעַל דַּעְתָּם וְעַל כַּוָּנָתָם אֲנִי אוֹמֵר כָּל אֵלּוּ הָעֲשָׂרָה קַפִּיטְל תְּהִלִּים, וּבִזְכוּתָם וְכֹחָם אֶזְכֶּה לְעוֹרֵר וּלְגַלּוֹת כָּל הָעֲשָׂרָה מִינֵי נְגִינָה שֶׁנֶּאֱמַר בָּהֶם סֵפֶר תְּהִלִּים, שֶׁהֵם: אַשְׁרֵי, בְּרָכָה, מַשְׂכִּיל, שִׁיר, נִצּוּחַ, נִגּוּן, תְּפִלָּה, הוֹדָאָה, מִזְמוֹר, הַלְלוּיָהּ. שֶׁהֵם שִׁיר פָּשׁוּט, כָּפוּל, מְשֻׁלָּש, מְרֻבָּע, שֶׁהֵם כְּלוּלִים בְּשִׁמְךָ הַמְיֻחָד הַגָּדוֹל וְהַקָדוֹשׁ. וּבִזְכוּת וְכֹחַ הַשְׁנֵי שְׁמוֹת הַקְּדוֹשִׁים הָאֵלּוּ בְּמִלּוּאָם, שֶׁהֵם אֵל אֱלֹהִים (כָּזֶה): אל”ף למ”ד, אל”ף למ”ד ה”יְ יו”ד מ”ם, שֶׁהֵם עוֹלִים בְּמִסְפָּר תפ”ה, כְּמִסְפַּר תְּהִלִּים. בְּכֹחַ אֵלוּ הַשֵּׁמוֹת תְּזַכֵּנִי לְתִקּוּן הַבְּרִית שֶׁהוּא תִּקּוּן הַכְּלָלִי אָמֵן`}
                     ...
                     <Typography variant="h3" color='primary' gutterBottom align='center' style={{paddingTop:25,}}>
                     {`מזמור – טז`}
                    </Typography>
...
כֹּל הַנְּשָׁמָה תְּהַלֵּל יָהּ הַלְלוּיָהּ`}
        ...
        <Card className={this.props.classes.paperTow} >  
        <Accordion >
        ...
        <AccordionDetails>
        <Typography variant="h5" gutterBottom align='center' color='textSecondary' style={{paddingTop:25,marginBottom:35}}>

               <Typography variant="h4" gutterBottom align='center' color='textSecondary' style={{paddingTop:25,marginBottom:35}}>
              ...
              רִבּוֹנוֹ שֶׁל עוֹלָם, אֵל חַי וְקַיָּם, חֵי הַחַיִּים, מָלֵא רַחֲמִים, הַדָּן אֶת כָּל הָעוֹלָם לְכַף זְכוּת תָּמִיד, הֶחָפֵץ חֶסֶד וּמַרְבֶּה לְהֵיטִיב. אָבִי אָבִי, גּוֹאֲלֵי וּפוֹדִי, יָדַעְתִּי יְהֹוָה יָדַעְתִּי, כִּי אֲנִי בְּעַצְמִי הַחַיָּב וְהַפּוֹשֵׁעַ, אֲפִלּוּ בְּהַמִּקְרוֹת שֶׁנִּזְדַּמְּנוּ לִי בְּשׁוֹגֵג
               ...
               <Typography variant="h4" gutterBottom align='center' color='textSecondary' >
               רִבּוֹנוֹ שֶׁל עוֹלָם, רִבּוֹנוֹ שֶׁל עוֹלָם, מָלֵא רַחֲמִים, מָלֵא חֶסֶד חִנָּם, מָלֵא חֲנִינוֹת, מָלֵא רַחֲמָנוּת, מָלֵא טוֹב, מָלֵא רָצוֹן, כְּבָר קִבַּלְנוּ עָלֵינוּ לִקְרֹא אֵלֶיךָ תָּמִיד, וְהִנְנִי מְקַיֵּם קַבָּלָתֵנוּ, וְהִנְנִי קוֹרֵא אֵלֶיךָ מִמָּקוֹם שָׁפָל כָּזֶה, מִמְּקוֹמוֹת מְגֻנִּים כָּאֵלֶּה, “מִמַּעֲמַקִּים קְרָאתִיךָ יְהֹוָה”, מֵעִמְקֵי עֲמָקִים, “מִן הַמֵּצַר קָרָאתִי יָּהּ, עָנָנִי בַמֶּרְחָב יָהּ”. וְאִם בַּעֲווֹנוֹתֵינוּ הָרַבִּים יָרַדְנוּ לְמָקוֹם שֶׁיָּרַדְנוּ, וְיָרַדְנוּ עַכְשָׁו בְּעִקְּבוֹת מְשִׁיחָא לִמְקוֹמוֹת נְמוּכִים וּשְׁפָלִים מְאֹד מְאֹד, שֶׁלֹּא יָרְדוּ יִשְׂרָאֵל לְתוֹכָם מֵעוֹלָם, כְּמוֹ שֶׁכָּתוּב: “וַתֵּרֶד פְּלָאִים, אֵין מְנַחֵם לָהּ”. אַף עַל פִּי כֵן, אֵין אָנוּ מְיָאֲשִׁים עַצְמֵנוּ חַס וְשָׁלוֹם בְּשׁוּם אֹפֶן בָּעוֹלָם כְּלָל, כִּי כְּבָר הִבְטַחְתָּנוּ לַהֲשִׁיבֵנוּ מִמְּצוּלוֹת יָם, כְּמוֹ שֶׁכָּתוּב: “אָמַר אֲדֹנִי, מִבָּשָׁן אָשִׁיב, אָשִׁיב מִמְּצוּלוֹת יָם”, וּכְתִיב: וְאַף גַּם זֹאת בִּהְיוֹתָם בְּאֶרֶץ אֹיְבֵיהֶם, לֹא מְאַסְתִּים וְלֹא גְעַלְתִּים לְכַלֹּתָם, לְהָפֵר בְּרִיתִי אִתָּם, כִּי אֲנִי יְהֹוָה אֱלֹהֵיהֶם         
                     </Typography>



               <Typography variant="h4" gutterBottom align='center' color='textSecondary' >
               רִבּוֹנוֹ שֶׁל עוֹלָם! פְּתַח פִּיךָ לְאִלֵּם כָּמוֹנִי, וְתִשְׁלַח לִי דִּבּוּרִים מִמְּעוֹן קָדְשְׁךָ מִן הַשָּׁמַיִם, בְּאֹפֶן שֶׁאוּכַל לְנַצֵּחַ אוֹתְךָ, לְרַצּוֹת וּלְפַיֵּס אוֹתְךָ, שֶּׁתְּקַבֵּל בְּרַחֲמֶיךָ הָרַבִּים וּבַחֲסָדֶיךָ הָעֲצוּמִים אֶת אֵלּוּ הָעֲשָׂרָה קַפִּיטְל תְּהִלִּים שֶׁאָמַרְתִּי לְפָנֶיךָ, כְּאִלּוּ אֲמָרָם דָּוִד הַמֶּלֶךְ עָלָיו הַשָּׁלוֹם בְּעַצְמוֹ, וְאַף עַל פִּי שֶׁאֵינִי יוֹדֵעַ לְכַוֵּן שׁוּם כַּוָּנָה מֵהַכַּוָּנוֹת הָעֲצוּמוֹת וְהַנּוֹרָאוֹת שֶׁיֵּשׁ בְּאֵלּוּ הָעֲשָׂרָה מִזְמוֹרִים, יְהִי רָצוֹן מִלְּפָנֶיךָ יְהֹוָה אֱלֹהַי וֵאלֹהֵי אֲבוֹתַי, שֶׁתְּהֵא חֲשׁוּבָה לְפָנֶיךָ הָאֲמִירָה בְּפֶה לְבַד, כְּאִלּוּ הִשַּׂגְתִּי וְכִוַּנְתִּי כָּל הַסּוֹדוֹת וְהַכַּוָּנוֹת שֶׁיֵּשׁ בָּהֶם וְיִהְיוּ אֲמָרַי לְרָצוֹן לִפְנֵי אֲדוֹן כָּל         
                     </Typography>



               <Typography variant="h4" gutterBottom align='center' color='textSecondary' >
וְהִנְנִי מַשְׁלִיךְ יְהָבֵי עָלֶיךָ, וְהִנְנִי מְקַשֵּׁר עַצְמִי לְכָל הַצַּדִּיקִים הָאֲמִתִּיִּים שֶׁבְּדוֹרֵנוּ, וּלְכָל הַצַּדִּיקִים הָאֲמִתִּיִּים שׁוֹכְנֵי עָפָר, קְדוֹשִׁים אֲשֶׁר בָּאָרֶץ הֵמָּה, ]וּבִפְרָט לְהַצַּדִּיק יְסוֹד עוֹלָם, נַחַל נֹבֵעַ מְקוֹר חָכְמָה, רַבֵּנוּ נַחְמָן בֶּן פֵיגֶא, זְכוּתוֹ יָגֵן עָלֵינוּ אָמֵן[, וְעַל דַּעְתָּם וְעַל כַּוָּנָתָם אָמַרְתִּי כָּל אֵלּוּ הָעֲשָׂרָה קַפִּיטְל תְּהִלִּים, וּבִזְכוּתָם וְכֹחָם אֶזְכֶּה לְעוֹרֵר וּלְגַלּוֹת כָּל הָעֲשָׂרָה מִינֵי נְגִינָה שֶׁנֶּאֱמַר בָּהֶם סֵפֶר תְּהִלִּים, שֶׁהֵם: שִׁיר פָּשׁוּט, כָּפוּל, מְשֻׁלָּשׁ, מְרֻבַּע, שֶׁהֵם כְּלוּלִים בְּשִׁמְךָ הַמְּיֻחָד הַגָּדוֹל וְהַקָּדוֹשׁ. וּבִזְכוּת וְכֹחַ הַשֵּׁנִי שֵׁמוֹת הַקְּדוֹשִׁים הָאֵלּוּ בִּמְלוּאָם, שֶׁהֵם אֶל אֱלֹהִים (כָזֶה): אָלֶ”ף לָמֶ”ד, אָלֶ”ף לָמֶ”ד הֵ”י יוּ”ד מֵ”ם, שֶׁהֵם עוֹלִים בְּמִסְפַּר תפ”הֵ (אַרְבַּע מֵאוֹת שְׁמוֹנִים וְחָמֵשׁ), כַּמִּסְפָּר תְּהִלִּים. בְּכֹחַ אֵלּוּ הַשֵּׁמוֹת תְּזַכֵּנִי לְהוֹצִיא כָּל הַטִּפּוֹת קֶרִי לְבַטָּלָה מִבֶּטֶן הַקְּלִפָּה שֶׁבְּלָעָם, אֲשֶׁר מִסְפַּר שְׁמָהּ עִם הָאוֹתִיּוֹת עוֹלֶה תפ”ה, שֶׁהִיא בַּקְּלִפָּה כְּנֶגֶד קְדֻשַּׁת סֵפֶר תְּהִלִּים, וּבְכֹחַ אֵלּוּ הָעֲשָׂרָה מִזְמוֹרֵי תְּהִלִּים תְּעוֹרֵר הַשֵּׁנִי שֵׁמוֹת הַקְּדוֹשִׁים אֵל אֱלֹהִים, וְתַהֲרֹג וּתְשַׁבֵּר וְתַכְנִיעַ וְתַעֲקֹר וּתְכַלֶּה וּתְבַטֵּל אֶת הַקְּלִפָּה הַזֹּאת שֶׁבְּלָעָם, וְתַכְרִיחַ אוֹתָהּ לְהַפְלִיט כָּל הַטִּפּוֹת הַקְּדוֹשׁוֹת מִבִּטְנָהּ וְקִרְבָּהּ, וְתִמְחֶה שְׁמָהּ וְזִכְרָהּ מִן הָעוֹלָם, וּתְקַיֵּם מִקְרָא שֶׁכָּתוּב: “חָיִל בָּלַע וִיקִיאֶנּוּ, מִבִּטְנוֹ יוֹרִישֶׁנּוּ אֶל”. וְתַהֲרֹג כָּל הַקְּלִפּוֹת שֶׁנִּבְרְאוּ עַל יְדֵי אֵלּוּ הַטִּפּוֹת, וְתוֹצִיא וְתִגְזֹל מֵהֶם הַחִיּוֹת דִּקְדֻשָּׁה, וְכָל הַנִּיצוֹצוֹת הַקְּדוֹשׁוֹת שֶׁבָּלְעוּ עַל יְדֵי פְּגַם חֵטְא זֶה, כֻּלָּם תּוֹצִיאֵם וְתַחֲזֹר וּתְקַבְּצֵם בִּקְדוּשָּׁה שֵׁנִית. וּתְזַכֵּנוּ לְקַבֵּל עָלֵינוּ עֹל מַלְכוּת שָׁמַיִם בְּאַהֲבָה תָּמִיד, וְנִזְכֶּה לַעֲסֹק כָּל יָמֵינוּ בְּתוֹרָה וּתְפִלָּה וּמַעֲשִׂים טוֹבִים בֶּאֱמֶת וּבְלֵב שָׁלֵם, בְּאֹפֶן שֶׁנִּזְכֶּה לִבְרֹא גּוּפִים וְכֵלִים קְדוֹשִׁים לְכָל הַנְשָׁמּוֹת דְּאָזְלִן עַרְטִילָאִין עַל יְדֵי עֲווֹנוֹתֵינוּ הָרַבִּים, עַל יְדֵי פְּגַם הַטִּפּוֹת קֶרִי שֶׁיָּצְאוּ מִמֶּנִּי לְבַטָּלָה        
       </Typography>



               <Typography variant="h4" gutterBottom align='center' color='textSecondary' >
               ."רִבּוֹנוֹ שֶׁל עוֹלָם, אַמִּיץ כֹּחַ וְרַב אוֹנִים, עֲשֵׂה מַה שֶּׁתַּעֲשֶׂה בְּרַחֲמֶיךָ הָרַבִּים בְּאֹפֶן שֶׁנִּזְכֶּה לְתַקֵּן פְּגַם הַבְּרִית, פְּגַם טִפֵּי הַמֹּחַ, בֵּין מַה שֶּׁפָּגַמְנוּ בָּזֶה בְּשׁוֹגֵג, בֵּין בְּמֵזִיד, בֵּין בְּאֹנֶס, בֵּין בְּרָצוֹן, עַל הַכֹּל תִּמְחַל וְתִסְלַח לִי אֱלוֹהַּ סְלִיחוֹת, חַנּוּן הַמַּרְבֶּה לִסְלֹחַ, וְנִזְכֶּה לְתַקֵּן כָּל הַפְּגָמִים בִּשְׁלֵמוּת בְּחַיֵּינוּ, בִּזְכוּת הַצַּדִּיקִים הַקְּדוֹשִׁים אֲשֶׁר בָּאָרֶץ הֵמָּה, (ואם יהיה על קברו הקדוש יאמר: וּבִזְכוּת הַצַּדִּיק הַזֶּה הַשּׁוֹכֵן פֹּה, צַדִּיק יְסוֹד עוֹלָם, נַחַל נוֹבֵעַ מְקוֹר חָכְמָה, אֲשֶׁר אֲנִי מְכַתֵּת רַגְלַי וְטִלְטַלְתִּי עַצְמִי בְּטִלְטוּל הַקָּשֶׁה בִּשְׁבִיל לָבוֹא הֵנָּה לְהִשְׁתַּטֵּחַ עַל קֶבֶר הַצַּדִּיק הָאֱמֶת הַקָּדוֹשׁ הַזֶּה, אֲשֶׁר הִבְטִיחָנוּ בְּחַיָּיו הַקְּדוֹשִׁים, לַעֲמֹד בְּעֶזְרָתֵנוּ סֶלָה תָּמִיד, כְּשֶׁנָּבוֹא עַל קִבְרוּ הַקָּדוֹשׁ וְנִתֵּן פְּרוּטָה לִצְדָקָה וְנֹאמַר אֵלּוּ הָעֲשָׂרָה קַפִּיטְל תְּהִלִּים, וְהִנֵּה עָשִׂיתִי מַה שֶׁמֻּטָּל עָלַי, עֲשֵׂה מַה שֶׁעָלֶיךָ). וּמְחֹל לִי וּסְלַח לִי וְכַפֵּר לִי עַל כָּל הַחֲטָאִים וְהָעֲווֹנוֹת וְהַפְּשָׁעִים, שֶׁחָטָאתִי וְשֶׁעָוִיתִי וְשֶׁפָּשַׁעְתִּי לְפָנֶיךָ בְּרְמַ”ח אֵיבָרַי וּשְׁסָ”ה גִּידַי, בְּמַחֲשָׁבָה דִּבּוּר וּמַעֲשֵׂה, וּבַחֲמִשָּׁה חוּשִׁים וּבִשְׁאָר כֹּחוֹת הַגּוּף, וּבִפְרָט מַה שֶׁחָטָאתִי וּפָשַׁעְתִּי וּפָגַמְתִּי נֶגְדֶּךָ בִּפְּגַם הַבְּרִית, שֶׁהוּא כְּלַל כָּל הַתּוֹרָה כֻּלָּהּ, “וְהָרַע בְּעֵינֶיךָ עָשִׂיתִי” מִנְּעוּרָי עַד הַיּוֹם הַזֶּה. עַל הַכֹּל תִּמְחַל וְתִסְלַח וּתְכַפֵּר, מָלֵּא רַחֲמִים, וּתְמַלֵּא כָּל הַשֵּׁמוֹת שֶׁפָּגַמְתִּי בְּשִׁמְךָ הַגָּדוֹל. “הֶרֶב כַּבְּסֵנִי מֵעֲוֹנִי, וּמֵחַטָּאתִי טַהֲרֵנִי. תְּחַטְּאֵנִי בְּאֵזוֹב וְאֶטְהָר, תְּכַבְּסֵנִי וּמִשֶּׁלֶג אַלְבִּין. תַּשְׁמִיעֵנִי שָׂשׂוֹן וְשִׂמְחָה, תָּגֵלְנָה עֲצָמוֹת דִּכִּיתָ הַסְתֵּר פָּנֶיךָ מֵחֲטָאָי, וְכָל עֲוֹנֹתַי מְחֵה”. מְחֵה פְּשָׁעַי לְמַעַנְךָ כָּאָמוּר: “אָנֹכִי אָנֹכִי הוּא מוֹחֶה פְשָׁעֶיךָ לְמַעֲנִי, וְחַטֹּאתֶיךָ לֹא 
               </Typography>
               ...
               <Typography variant="h4" gutterBottom align='center' color='textSecondary'>
               ."וְתִמָּלֵא עָלַי בְּרַחֲמִים, וְתִהְיֶה בְּעֶזְרִי תָּמִיד, בִּזְכוּת וְכֹחַ הַצַּדִּיקִים הָאֲמִתִּיִּים, וְתִשְׁמְרֵנִי וְתַצִּילֵנִי תָּמִיד, וְתִתֵּן לִי כֹּחַ לְהִתְגַּבֵּר עַל יִצְרִי וְלָכוֹף וּלְשַׁבֵּר אֶת תַּאֲוָתִי, וְלֹא אֶפְגֹּם עוֹד מַה שֶׁפָּגַמְתִּי, וְלֹא אֶעֱשֶׂה עוֹד הָרַע בְּעֵינֶיךָ, וְלֹא אָשׁוּב עוֹד לְכִסְלָה, אִם אָוֶן פָּעַלְתִּי לֹא אוֹסִיף, כִּי כְּבָר הִבְטַחְתָּנוּ, שֶׁגַּם עַל זֶה מוֹעִיל תְּפִלָּה וּבַקָּשָׁה, לְהִנָּצֵל לְהַבָּא בְּרַחֲמֶיךָ הָאֲמִתִּיִּים מִן הַיֵּצֶר הָרָע וְכַת דִילֵהּ, (ואם יהיה על קברו הקדוש יאמר: וּבִפְרָט עַל מָקוֹם צִיּוֹן הַקָּדוֹשׁ הַזֶּה, עָזְרֵנִי בִּזְכוּת הַצַּדִּיקִים הַגְּנוּזִים פֹּה), וָרָחַם עָלַי וְתֶן לִי כֹּחַ וּגְבוּרָה מֵאִתָּךְ, שֶׁאֶזְכֶּה לְהִתְגַּבֵּר וְלִכְבֹּשׁ אֶת יִצְרִי  תָּמִיד, עַד שֶׁאֶזְכֶּה בְּרַחֲמֶיךָ לְגָרְשׁוֹ וּלְסַלְּקוֹ וּלְבַטְּלוֹ מֵעָלַי לְגַמְרֵי מֵעַתָּה וְעַד עוֹלָם, כִּי כְּבָר “כָּלוּ בְּיָגוֹן חַיַּי, וּשְׁנוֹתַי בַּאֲנָחָה. כָּשַׁל בַּעֲוֹנִי כֹּחִי, וַעֲצָמַי עָשֵׁשׁוּ”, עַד אֲשֶׁר “כָּשַׁל כֹּחַ הַסַּבָּל”. רַחֵם עָלַי, אֲבִי אָב הָרַחֲמָן, רַחֵם עָלַי שׁוֹמֵעַ תְּפִלָּה, חוּס וַחֲמֹל עָלַי שׁוֹמֵעַ צְעָקָה, שׁוֹמֵעַ אֲנָחָה, שׁוֹמֵעַ אֲנָקָה. רַחֵם רַחֵם, הַצֵּל הַצֵּל, הוֹשִׁיעָה הוֹשִׁיעָה, “אַל יִפֹּל דָּמִי אַרְצָה” לְפָנֶיךָ, אַל תִּתֵּן לְשַׁחַת נַפְשִׁי, “הַצִּילֵנִי מִדָּמִים אֱלֹהִים אֱלֹהֵי תְשׁוּעָתִי, תְּרַנֵּן לְשׁוֹנִי צִדְקָתֶךָ”, חוּסָה עָלַי כְּרֹב רַחֲמֶיךָ, כְּרֹב חֲסָדֶיךָ, יֶהֱמוּ נָא מֵעֶיךָ וַחֲנִינוֹתֶיךָ עַל עֲלוּב נֶפֶשׁ כָּמוֹנִי, עַל נִרְדָּף כָּמוֹנִי, עַל מְלֻכְלָךְ בַּחֲטָאִים כָּמוֹנִי, עַל חֲסַר דֵּעָה חֲסַר עֵצָה כָּמוֹנִי, כִּי לְךָ לְבַד עֵינֵינוּ תְּלוּיוֹת, לְךָ לְבַד רַעְיוֹנַי צוֹפִיּוֹת, “דַּלּוּ עֵינַי לַמָּרוֹם”, עֲזֹר נָא הוֹשִׁיעָה נָא, חוּס וַחֲמֹל נָא עָלַי, וְהוֹשִׁיעֵנִי לָשׁוּב אֵלֶיךָ בִּתְשׁוּבָה שְׁלֵמָה בֶּאֱמֶת וּבְלֵב שָׁלֵם, וְאֶזְכֶּה לִהְיוֹת תָּמִיד כִּרְצוֹנְךָ הַטּוֹב מֵעָתָּה וְעַד עוֹלָם, “כְּחַסְדְּךָ חַיֵּנִי, וְאֶשְׁמְרָה עֵדוּת פִּיךָ. לֵב טָהוֹר בְּרָא לִי אֱלֹהִים, וְרוּחַ נָכוֹן חַדֵּשׁ 
               </Typography>
               ...
               <Typography variant="h4" gutterBottom align='center' color='textSecondary' >
 ."וּבְכֵן יְהִי רָצוֹן מִלְּפָנֶיךָ יְהֹוָה אֱלֹהֵינוּ וֵאלֹהֵי אֲבוֹתֵינוּ, אֲדוֹן הַשִּׂמְחָה וְהַחֶדְוָה, אֲשֶׁר לְפָנֶיךָ אֵין שׁוּם עַצְבוּת כְּלָל לְעוֹלָם, כְּמוֹ שֶׁכָּתוּב: “הוֹד וְהָדָר לְפָנָיו, עֹז וְחֶדְוָה בִּמְקוֹמוֹ”, שֶׁתַּעְזְרֵנִי בְּרַחֲמֶיךָ הָעֲצוּמִים, וּתְזַכֵּנִי לִהְיוֹת בְּשִׂמְחָה תָּמִיד. מְשַׂמֵּחַ נַפְשׁוֹת עֲגוּמִים, שַׂמַּח נַפְשִׁי הָאֻמְלָלָה מְאֹד, הָעֲלוּבָה מְאֹד, הָעֲיֵפָה וְהַצְּמֵאָה וְהָרְעֵבָה אֵלֶיךָ מְאֹד. הָסֵר מִמֶּנִּי יָגוֹן וַאֲנָחָה, “שָׂמֵחַ נֶפֶשׁ עַבְדֶּךָ, כִּי אֵלֶיךָ יְהֹוָה נַפְשִׁי אֶשָּׂא. תּוֹדִיעֵנִי אֹרַח חַיִּים, שֹׂבַע שְׂמָחוֹת אֶת פָּנֶיךָ, נְעִימוֹת בִּימִינְךָ נֶצַח. הָשִׁיבָה לִי שָׂשׂוֹן יִשְׁעֶךָ, וְרוּחַ נְדִיבָה תִסְמְכֵנִי”. שַׂבְּעֵנִי מִטּוּבֶךָ, וְשַׂמַּח נַפְשִׁי בִּישׁוּעָתֶךָ, וְטַהֵר לִבִּי לְעָבְדְּךָ בֶּאֱמֶת. “עוּרָה כְבוֹדִי, עוּרָה הַנֵּבֶל וְכִנּוֹר, אָעִירָה שָּׁחַר”. זַכֵּנִי לְכָל הָעֲשָׂרָה מִינֵי נְגִינָה דִּקְדֻשָּׁה, שֶׁהֵם מַכְנִיעִים וּמְתַקְּנִים פְּגַם הַבְּרִית, כָּאָמוּר: “אֲבָרֵךְ אֶת יְהֹוָה אֲשֶׁר יְעָצָנִי, אַף לֵילוֹת יִסְּרוּנִי כִלְיוֹתָי: לְדָוִד מַשְׂכִּיל, אַשְׁרֵי נָשׂוּי פֶּשַׁע כְּסוּי חֲטָאָה: בַּיִת וָהוֹן נַחֲלַת אֲבוֹת, וּמֵיְהֹוָה אִשָּׁה מַשְׂכָּלֶת: יוֹמָם יְצַוֶּה יְהֹוָה חַסְדּוֹ, וּבַלַּיְלָה שִׁירֹה עִמִּי, תְּפִלָּה לְאֵל חַיַּי: לַמְנַצֵּחַ אֶל תַּשְׁחֵת לְדָוִד מִכְתָּם בִּשְׁלֹחַ שָׁאוּל וַיִּשְׁמְרוּ אֶת הַבַּיִת לַהֲמִיתוֹ: אֶזְכְּרָה נְגִינָתִי בַּלַּיְלָה, עִם לְבָבִי אָשִׂיחָה וַיְחַפֵּשׂ רוּחִי: הֲיֵאָכֵל תָּפֵל מִבְּלִי מֶלַח, אִם יֶשׁ טַעַם בְּרִיר חַלָּמוּת. פֶּן תִּתֵּן לַאֲחֵרִים הוֹדֶךָ, וּשְׁנוֹתֶיךָ לְאַכְזָרִי, וְלֹא אָמַר אַיֵּה אֱלֹהַי עֹשָׂי, נוֹתֵן זְמִירוֹת בַּלָּיְלָה: שֶׁקֶר הַחֵן וְהֶבֶל הַיֹּפִי, אִשָּׁה יִרְאַת יְהֹוָה הִיא תִּתְהַלָּל”: וְנֶאֱמַר: “הַלְלוּיָה, הַלְלוּ אֵל בְּקָדְשׁוֹ, הַלְלוּהוּ בִּרְקִיעַ עֻזּוֹ. הַלְלוּהוּ בִּגְבוּרוֹתָיו, הַלְלוּהוּ כְּרֹב גֻּדְלוֹ. הַלְלוּהוּ בְּתֵקַע שׁוֹפָר, הַלְלוּהוּ בְּנֵבֶל וְכִנּוֹר. הַלְלוּהוּ בְּתֹף וּמָחוֹל, הַלְלוּהוּ בְּמִנִּים וְעֻגָב: הַלְלוּהוּ בְּצִלְצְלֵי שָׁמַע, הַלְלוּהוּ בְּצִלְצְלֵי תְרוּעָה. כָּל הַנְּשָׁמָה תְּהַלֵּל יָהּ,
               </Typography>
               ...
               <Typography variant="h4" gutterBottom align='center' color='textSecondary' >
               .רִבּוֹנוֹ שֶׁל עוֹלָם, תְּקַע בְּשׁוֹפָר גָּדוֹל לְחֵרוּתֵנוּ, וְשָׂא נֵס לְקַבֵּץ גָּלֻיּוֹתֵינוּ, וְקָרֵב פְּזוּרֵנוּ מִבֵּין הַגּוֹיִם, וּנְפוּצוֹתֵינוּ כַּנֵּס מִיַּרְכְּתֵי אָרֶץ, וְקַבֵּץ נִדָּחֵינוּ יַחַד מֵאַרְבַּע כַּנְפוֹת הָאָרֶץ לְאַרְצֵנוּ, וְקַיֶּם בָּנוּ מִקְרָא שֶׁכָּתוּב: “וְשָׁב יְהֹוָה אֱלֹהֶיךָ אֶת שְׁבוּתְךָ וְרִחַמֶךָ, וְשָׁב וְקִבֶּצְךָ מִכָּל הָעַמִּים אֲשֶׁר הֱפִיצְךָ יְהֹוָה אֱלֹהֶיךָ שָׁמָּה. אִם יִהְיֶה נִדַּחֲךָ בִּקְצֵה הַשָּׁמָיִם, מִשָּׁם יְקַבֶּצְךָ יְהֹוָה אֱלֹהֶיךָ וּמִשָּׁם יִקָּחֶךָ. וֶהֱבִיאֲךָ יְהֹוָה אֱלֹהֶיךָ אֶל הָאָ����ֶץ אֲשֶׁר יָרְשׁוּ אֲבֹתֶיךָ וִירִשְׁתָּהּ, וְהֵיטִיבְךָ וְהִרְבְּךָ מֵאֲבֹתֶיךָ”. וְנֶאֱמַר: “נְאֻם אֲדֹנִי יֱהֹוָה, מְקַבֵּץ נִדְחֵי יִשְׂרָאֵל, עוֹד אֲקַבֵּץ עָלָיו לְנִקְבָּצָיו”. וְנֶאֱמַר: “בּוֹנֶה יְרוּשָׁלַיִם יְהֹוָה נִדְחֵי יִשְׂרָאֵל יִכָנֵּס”. וּתְמַהֵר וְתָחִישׁ לְגָאֳלֵנוּ, וְתָבִיא לָנוּ אֶת מְשִׁיחַ צִדְקֵנוּ, וְתִבְנֶה אֶת בֵּית קָדְשֵׁנוּ וְתִפְאַרְתֵּנוּ, וַהֲבִיאֵנוּ לְצִיּוֹן עִירְךָ בְּרִנָּה, וְלִירוּשָׁלַיִם בֵּית מִקְדָּשְׁךָ בְּשִׂמְחַת עוֹלָם, כְּמוֹ שֶׁכָּתוּב: “וּפְדוּיֵי יְהֹוָה יְשֻׁבוּן וּבָאוּ צִיּוֹן בְּרִנָּה וְשִׂמְחַת עוֹלָם עַל רֹאשָׁם, שָׂשׂוֹן וְשִׂמְחָה יַשִּׂיגוּ וְנָסוּ יָגוֹן וַאֲנָחָה”. וְנֶאֱמַר: “כִּי בְשִׂמְחָה תֵצְאוּ וּבְשָׁלוֹם תּוּבָלוּן, הֶהָרִים וְהַגְּבָעוֹת יִפְצְחוּ לִפְנֵיכֶם רִנָּה, וְכָל עֲצֵי הַשָּׂדֶה יִמְחֲאוּ כַף”. וְנֶאֱמַר: “כִּי נִחַם יְהֹוָה צִיּוֹן, נִחַם כָּל חָרְבוֹתֶיהָ, וַיָּשֶׂם מִדְבָּרָהּ כְּעֵדֶן וְעַרְבָתָהּ כְּגַן יְהֹוָה, שָׂשׂוֹן וְשִׂמְחָה יִמָּצֵא בָהּ, תּוֹדָה וְקוֹל זִמְרָה. שִׂמְחוּ בַּיהֹוָה וְגִילוּ צַדִּיקִים וְהַרְנִינוּ כָּל יִשְׁרֵי לֵב. אוֹר זָרֻעַ לַצַּדִּיק, וּלְיִשְׁרֵי לֵב שִׂמְחָה. שִׂמְחוּ צַדִּיקִים בַּיהֹוָה, וְהוֹדוּ לְזֵכֶר קָדְשׁוֹ”. אָמֵן נֶצַח סֶלָה וָעֶד
               </Typography>
...
export default withStyles(styles)(RabbiNachman);